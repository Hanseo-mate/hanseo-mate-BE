...
@Setter
@NoArgsConstructor
public final class AppPopupUpdateRequest {
    ...
    @Schema(description = "기존 이미지 처리 방식", allowableValues = {"KEEP", "REPLACE", "REMOVE"})
    @NotNull(message = "이미지 처리 방식은 필수입니다.")
    private PopupImageAction imageAction;
