...
public class UserAccount extends BaseTimeEntity {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "preferred_campus_code", nullable = false, length = 20)
    ...
    private UserAccount(String loginId, String passwordHash) {
        ...
        this.preferredCampusCode = CampusCode.SEOSAN;
    }
    ...
    public void changePreferredCampusCode(CampusCode preferredCampusCode) {
        this.preferredCampusCode = preferredCampusCode;
    }
}
